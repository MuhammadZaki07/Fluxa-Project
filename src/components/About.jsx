const About = () => {
  return (
    <section
      id="aboutus"
      className="bg-[#E6E7EE] w-full py-32 flex flex-col px-40"
    >
      ...
      <div className="container flex justify-center py-24">
        <div
          className="border border-black w-96 h-96 translate-x-[7%] rounded-full flex justify-center items-center flex-col gap-3"
          data-aos="fade-left"
        >
          <h1 className="font-bold text-5xl text-center">80%</h1>
          <h2 className="font-medium text-lg text-center">Satisfied Clients</h2>
        </div>
        <div
          className="border border-black w-96 h-96 rounded-full flex justify-center items-center flex-col gap-3"
          data-aos="zoom-in"
        >
